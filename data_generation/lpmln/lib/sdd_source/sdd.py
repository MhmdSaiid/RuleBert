...
def sdd_array_element(*args):
  return _sdd.sdd_array_element(*args)
sdd_array_element = _sdd.sdd_array_element

def sdd_array_int_element(*args):
  return _sdd.sdd_array_int_element(*args)
sdd_array_int_element = _sdd.sdd_array_int_element

def new_array_of_sdd_literals(*args):
  return _sdd.new_array_of_sdd_literals(*args)
new_array_of_sdd_literals = _sdd.new_array_of_sdd_literals

def set_element_of_sdd_lit_array(*args):
  return _sdd.set_element_of_sdd_lit_array(*args)
set_element_of_sdd_lit_array = _sdd.set_element_of_sdd_lit_array
PRIsS = _sdd.PRIsS
PRInsS = _sdd.PRInsS
PRIrcS = _sdd.PRIrcS
PRImcS = _sdd.PRImcS
