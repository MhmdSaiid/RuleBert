...
class lpmln2lpmlnnet(object):
    ...
    def p_statement_14(self,t):
        ...
        if weight>=0:
            ...
            if var == "":
                para = "(" + "lpmlnneg_" + id + ",\"" + str(weight) + "\"" + ")"
                para_2 = "(" + "lpmlnneg_" + id + ",\"" + weight_str + "\"" + ")"
            else:
                para = "(" + "lpmlnneg_" + id + ",\"" + str(weight) + "\"" + "," + var + ")"
                para_2 = "(" + "lpmlnneg_" + id + ",\"" + weight_str + "\"" + "," + var + ")"
            ...
            if len(t) == 5 and t[3] == ":-" and t[4] == '.':  # In the case of "num_process Head :- DOT"
                ...
                if len(self.disjunctedHead) == 0:
                    ...
                    for item in self.disjunctedHead:
                        middle += " not " + item + ','
                    line_2_body = "not " + first + ',' + middle + "not " + last
                    line_2 = "neg" + para + " :- " + line_2_body
                ...
                if len(self.disjunctedHead) == 0:
                    ...
                    for item in self.disjunctedHead:
                        middle += " not " + item + ','
                    line_2_body = "not " + first + ',' + middle + "not " + last
                    line_2 = "neg" + para + " :- " + body + ' , ' + line_2_body
    ...
    def __init__(self,content,weightFactor=1000):
        self.ruleCounter = 1
